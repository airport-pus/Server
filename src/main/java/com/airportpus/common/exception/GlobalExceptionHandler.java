...
import com.airportpus.common.logging.LoggingUtils;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(AirportPusException.class)
    public ResponseEntity<ErrorResponse> handleApplicationException(AirportPusException exception) {
